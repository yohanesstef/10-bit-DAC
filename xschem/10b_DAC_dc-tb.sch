...
N 480 -80 530 -80 {lab=GND}
N 640 -300 660 -300 {lab=VOUT}
N 390 -290 390 -270 {lab=VDDA2}
N 390 -250 390 -230 {lab=GND}
C {devices/title.sym} 160 -30 0 0 {name=l3 author="Yohanes Stefanus"}
C {devices/launcher.sym} 230 -460 0 0 {name=h5
descr="load tran" 
...
C {devices/lab_pin.sym} 780 -220 0 0 {name=p101 sig_type=std_logic lab=GND}
...
C {devices/ammeter.sym} 370 -130 0 1 {name=Vmeas1 savecurrent=true spice_ignore=0}
...
C {devices/lab_pin.sym} 480 -80 0 0 {name=p119 sig_type=std_logic lab=GND}
C {devices/ammeter.sym} 290 -130 0 1 {name=Vmeas savecurrent=true spice_ignore=0}
C {devices/ammeter.sym} 530 -110 0 0 {name=Vmeas2 savecurrent=true spice_ignore=0}
...
"}
C {devices/ammeter.sym} 480 -110 0 1 {name=Vmeas3 savecurrent=true spice_ignore=0}
...
C {devices/res.sym} 480 -170 0 1 {name=R4
value=1.759MEG
footprint=1206
device=resistor
m=1}
C {devices/res.sym} 530 -170 0 0 {name=R5
value=671.63k
footprint=1206
device=resistor
m=1}
C {devices/code.sym} 50 -360 0 0 {name=TT_MODELS
only_toplevel=true
