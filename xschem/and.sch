...
N 360 -340 370 -340 {lab=VDD}
N 370 -370 370 -340 {lab=VDD}
N 360 -370 370 -370 {lab=VDD}
N 210 -390 210 -370 {lab=VDD}
N 360 -290 450 -290 {lab=#net2}
...
C {devices/lab_pin.sym} 210 -390 0 0 {name=p3 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 170 -340 0 0 {name=p4 sig_type=std_logic lab=in1}
C {devices/lab_pin.sym} 750 -290 0 1 {name=p9 sig_type=std_logic lab=out}
C {devices/ipin.sym} 70 -230 0 0 {name=p10 lab=in1}
C {sky130_fd_pr/pfet_01v8.sym} 190 -340 0 0 {name=M1
L=l
W=wp
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8.sym} 340 -340 0 0 {name=M2
L=l
W=wp
nf=1
mult=1
...
C {sky130_fd_pr/nfet_01v8.sym} 340 -230 0 0 {name=M3
L=l
W=wn
nf=1 
mult=1
...
C {inv.sym} 600 -270 0 0 {name=x1}
C {devices/lab_pin.sym} 450 -270 0 0 {name=p11 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 450 -250 0 0 {name=p12 sig_type=std_logic lab=GND}
