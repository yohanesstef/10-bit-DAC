...
N 480 -700 880 -700 {lab=n2}
N 480 -770 880 -770 {lab=n1}
...
N 290 -690 300 -690 {lab=VDDA}
N 290 -790 290 -690 {lab=VDDA}
N 290 -790 300 -790 {lab=VDDA}
N 290 -760 300 -760 {lab=VDDA}
N 290 -530 300 -530 {lab=VDDA}
N 290 -690 290 -530 {lab=VDDA}
N 290 -610 300 -610 {lab=VDDA}
N 1390 -690 1400 -690 {lab=VDDA}
N 1400 -790 1400 -690 {lab=VDDA}
N 1390 -790 1400 -790 {lab=VDDA}
N 1390 -760 1400 -760 {lab=VDDA}
N 480 -700 480 -690 {lab=n2}
N 690 -700 690 -690 {lab=n2}
N 880 -700 880 -690 {lab=n2}
N 880 -770 880 -760 {lab=n1}
N 690 -770 690 -760 {lab=n1}
N 480 -770 480 -760 {lab=n1}
N 520 -690 530 -690 {lab=VDDA}
N 530 -790 530 -690 {lab=VDDA}
N 520 -760 530 -760 {lab=VDDA}
N 730 -690 740 -690 {lab=VDDA}
N 740 -790 740 -690 {lab=VDDA}
N 730 -760 740 -760 {lab=VDDA}
N 920 -690 930 -690 {lab=VDDA}
N 930 -790 930 -690 {lab=VDDA}
N 920 -760 930 -760 {lab=VDDA}
N 1380 -450 1390 -450 {lab=GNDA}
N 1380 -450 1380 -340 {lab=GNDA}
N 1380 -340 1390 -340 {lab=GNDA}
N 1380 -370 1390 -370 {lab=GNDA}
N 1160 -450 1170 -450 {lab=GNDA}
N 1160 -450 1160 -340 {lab=GNDA}
N 1160 -340 1170 -340 {lab=GNDA}
N 1160 -370 1170 -370 {lab=GNDA}
N 910 -450 920 -450 {lab=GNDA}
N 910 -450 910 -370 {lab=GNDA}
N 910 -370 920 -370 {lab=GNDA}
N 910 -370 910 -340 {lab=GNDA}
N 910 -340 920 -340 {lab=GNDA}
N 720 -450 730 -450 {lab=GNDA}
N 720 -450 720 -340 {lab=GNDA}
N 720 -340 730 -340 {lab=GNDA}
N 720 -370 730 -370 {lab=GNDA}
N 510 -450 520 -450 {lab=GNDA}
N 510 -450 510 -340 {lab=GNDA}
N 510 -340 520 -340 {lab=GNDA}
N 510 -370 520 -370 {lab=GNDA}
N 70 -710 70 -650 {lab=VDDA}
N 70 -680 110 -680 {lab=VDDA}
N 70 -620 70 -560 {lab=VDDA}
N 70 -590 110 -590 {lab=VDDA}
N 1160 -690 1170 -690 {lab=VDDA}
N 1160 -790 1160 -690 {lab=VDDA}
N 1160 -760 1170 -760 {lab=VDDA}
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 320 -760 0 1 {name=M1
L=1
W=1.8
nf=1
mult=2
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 320 -690 0 1 {name=M2
L=1
W=1.8
nf=1
mult=2
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 320 -610 0 1 {name=M3
L=20
W=1.8
nf=1
mult=2
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 320 -530 0 1 {name=M4
L=20
W=1.8
nf=1
mult=2
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 500 -760 0 0 {name=M5
L=1
W=1.8
nf=1
mult=2
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 500 -690 0 0 {name=M6
L=1
W=1.8
nf=1
mult=2
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 710 -760 0 0 {name=M9
L=1
W=1.8
nf=1
mult=2
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 710 -690 0 0 {name=M10
L=1
W=1.8
nf=1
mult=2
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 900 -760 0 0 {name=M11
L=1
W=1.8
nf=1
mult=2
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 900 -690 0 0 {name=M12
L=1
W=1.8
nf=1
mult=2
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 1370 -760 0 0 {name=M22
L=1
W=1.8
nf=1
mult=2
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 1370 -690 0 0 {name=M23
L=1
W=1.8
nf=1
mult=2
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 540 -450 0 1 {name=M7
L=1
W=0.6
nf=1
mult=2
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 540 -370 0 1 {name=M8
L=1
W=0.6
nf=1
mult=2
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 1190 -450 0 1 {name=M13
L=1
W=0.6
nf=1
mult=2
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 1190 -370 0 1 {name=M15
L=1
W=0.6
nf=1
mult=2
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 750 -450 0 1 {name=M19
L=1
W=0.6
nf=1
mult=2
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 940 -450 0 1 {name=M20
L=1
W=0.6
nf=1
mult=2
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 1410 -450 0 1 {name=M25
L=1
W=0.6
nf=1
mult=2
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 750 -370 0 1 {name=M14
L=5.3
W=0.6
nf=1
mult=1
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 940 -370 0 1 {name=M16
L=9.7
W=0.61
nf=1
mult=1
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 1410 -370 0 1 {name=M27
L=12
W=0.64
nf=1
mult=1
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 1190 -690 0 1 {name=M18
L=1
W=1.8
nf=1
mult=2
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 1190 -760 0 1 {name=M17
L=9.2
W=1
nf=1
mult=1
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 90 -680 0 1 {name=M28
L=20
W=1.8
nf=1
mult=2
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 90 -590 0 1 {name=M29
L=20
W=1.8
nf=1
mult=2
...
C {devices/lab_pin.sym} 110 -680 0 1 {name=p2 sig_type=std_logic lab=VDDA}
C {devices/lab_pin.sym} 110 -590 0 1 {name=p32 sig_type=std_logic lab=VDDA}
