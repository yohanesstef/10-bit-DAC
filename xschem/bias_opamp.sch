...
N 460 -560 790 -560 {lab=VHEAD2}
N 590 -640 790 -640 {lab=VHEAD1}
...
N 640 -660 640 -630 {lab=VDDA}
N 410 -550 420 -550 {lab=VDDA}
N 410 -660 410 -550 {lab=VDDA}
N 410 -660 420 -660 {lab=VDDA}
N 410 -630 420 -630 {lab=VDDA}
N 460 -560 460 -550 {lab=VHEAD2}
N 510 -560 510 -550 {lab=VHEAD2}
N 590 -560 590 -550 {lab=VHEAD2}
N 790 -560 790 -550 {lab=VHEAD2}
N 410 -230 420 -230 {lab=VDDA}
N 410 -550 410 -230 {lab=VDDA}
N 410 -470 420 -470 {lab=VDDA}
N 410 -390 420 -390 {lab=VDDA}
N 410 -310 420 -310 {lab=VDDA}
N 830 -550 840 -550 {lab=VDDA}
N 840 -660 840 -550 {lab=VDDA}
N 830 -630 840 -630 {lab=VDDA}
...
N 1260 -220 1300 -220 {lab=GNDA}
N 260 -460 260 -400 {lab=VDDA}
N 260 -430 300 -430 {lab=VDDA}
N 260 -570 260 -510 {lab=VDDA}
N 260 -540 300 -540 {lab=VDDA}
N 260 -630 260 -570 {lab=VDDA}
N 260 -600 300 -600 {lab=VDDA}
N 1300 -460 1300 -400 {lab=GNDA}
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 440 -630 0 1 {name=M1
L=1
W=1.8
nf=1
mult=20
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 440 -550 0 1 {name=M2
L=1
W=1.8
nf=1
mult=20
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 610 -630 0 0 {name=M7
L=1
W=1.8
nf=1
mult=20
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 610 -550 0 0 {name=M8
L=1
W=1.8
nf=1
mult=20
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 440 -470 0 1 {name=M3
L=20
W=1.8
nf=1
mult=2
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 440 -390 0 1 {name=M4
L=20
W=1.8
nf=1
mult=2
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 440 -310 0 1 {name=M5
L=20
W=1.8
nf=1
mult=2
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 440 -230 0 1 {name=M6
L=20
W=1.8
nf=1
mult=2
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 810 -630 0 0 {name=M13
L=1
W=1.8
nf=1
mult=8
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 810 -550 0 0 {name=M14
L=1
W=1.8
nf=1
mult=8
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 1120 -630 0 1 {name=M17
L=1
W=4.8
nf=1
mult=2
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 1120 -550 0 1 {name=M18
L=1
W=4.8
nf=1
mult=2
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 650 -230 0 1 {name=M11
L=1
W=0.6
nf=1
mult=20
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 650 -310 0 1 {name=M12
L=1
W=0.6
nf=1
mult=20
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 650 -470 0 1 {name=M9
L=20
W=0.6
nf=1
mult=2
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 650 -390 0 1 {name=M10
L=20
W=0.6
nf=1
mult=2
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 1280 -300 0 0 {name=M22
L=1
W=0.6
nf=1
mult=6
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 1080 -230 0 0 {name=M19
L=1
W=0.6
nf=1
mult=8
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 1080 -310 0 0 {name=M20
L=1
W=0.6
nf=1
mult=8
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 850 -230 0 1 {name=M15
L=1
W=1.6
nf=1
mult=2
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 850 -310 0 1 {name=M16
L=1
W=1.6
nf=1
mult=2
...
C {devices/lab_pin.sym} 1260 -300 0 0 {name=p18 sig_type=std_logic lab=GNDA}
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 1280 -220 0 0 {name=M23
L=1
W=0.6
nf=1
mult=6
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 280 -430 0 1 {name=M24
L=1
W=1.8
nf=1
mult=8
...
C {devices/lab_pin.sym} 300 -430 0 1 {name=p19 sig_type=std_logic lab=VDDA}
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 280 -540 0 1 {name=M25
L=1
W=1.8
nf=1
mult=16
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 280 -600 0 1 {name=M26
L=1
W=1.8
nf=1
mult=16
...
C {devices/lab_pin.sym} 300 -540 0 1 {name=p20 sig_type=std_logic lab=VDDA}
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 1280 -430 0 0 {name=M27
L=1
W=0.6
nf=1
mult=4
