...
S {}
E {}
N 180 -180 190 -180 {lab=VDDA}
N 180 -210 180 -180 {lab=VDDA}
N 180 -210 190 -210 {lab=VDDA}
N 190 -210 1400 -210 {lab=VDDA}
N 230 -190 230 -180 {lab=G1}
N 230 -190 1360 -190 {lab=G1}
N 1360 -190 1360 -180 {lab=G1}
N 370 -190 370 -180 {lab=G1}
N 560 -190 560 -180 {lab=G1}
N 720 -190 720 -180 {lab=G1}
N 880 -190 880 -180 {lab=G1}
N 1040 -190 1040 -180 {lab=G1}
N 1200 -190 1200 -180 {lab=G1}
N 410 -210 410 -180 {lab=VDDA}
N 600 -210 600 -180 {lab=VDDA}
N 760 -210 760 -180 {lab=VDDA}
N 1400 -210 1400 -180 {lab=VDDA}
N 1240 -210 1240 -180 {lab=VDDA}
N 1080 -210 1080 -180 {lab=VDDA}
N 920 -210 920 -180 {lab=VDDA}
...
C {devices/ipin.sym} 100 -450 0 0 {name=p30 lab=G1}
...
C {devices/lab_pin.sym} 180 -210 0 0 {name=p10 sig_type=std_logic lab=VDDA}
C {devices/lab_pin.sym} 310 -190 0 0 {name=p11 sig_type=std_logic lab=G1}
