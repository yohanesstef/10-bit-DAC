...
N 640 -340 640 -280 {lab=VDDA}
N 600 -310 640 -310 {lab=VDDA}
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 620 -310 0 0 {name=M5
L=1
W=1.8
nf=1
mult=8
...
C {devices/lab_pin.sym} 600 -310 0 0 {name=p5 sig_type=std_logic lab=VDDA}
