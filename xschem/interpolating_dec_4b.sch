...
N 900 -170 900 -160 {lab=VNB}
N 860 -160 860 -150 {lab=bb[0]}
N 260 -190 690 -190 {lab=VH}
N 1040 -170 1040 -160 {lab=VNB}
N 1000 -160 1000 -150 {lab=bb[1]}
N 1180 -170 1180 -160 {lab=VNB}
N 1140 -160 1140 -150 {lab=bb[2]}
N 1320 -170 1320 -160 {lab=VNB}
N 1280 -160 1280 -150 {lab=bb[3]}
...
C {devices/lab_pin.sym} 860 -150 2 1 {name=p13 sig_type=std_logic lab=bb[0]}
C {devices/lab_pin.sym} 1000 -150 2 1 {name=p17 sig_type=std_logic lab=bb[1]}
C {devices/lab_pin.sym} 1140 -150 2 1 {name=p18 sig_type=std_logic lab=bb[2]}
C {devices/lab_pin.sym} 1280 -150 2 1 {name=p19 sig_type=std_logic lab=bb[3]}
C {devices/lab_pin.sym} 860 -170 2 1 {name=p21 sig_type=std_logic lab=VNB}
C {devices/ipin.sym} 80 -200 0 0 {name=p1 lab=VH}
C {devices/ipin.sym} 80 -180 0 0 {name=p22 lab=VL}
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 880 -160 2 1 {name=M5
L=l
W=wn
nf=1
mult=1
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 1020 -160 2 1 {name=M6
L=l
W=wn
nf=1
mult=1
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 1160 -160 2 1 {name=M7
L=l
W=wn
nf=1
mult=1
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 1300 -160 2 1 {name=M8
L=l
W=wn
nf=1
mult=1
...
C {devices/ipin.sym} 80 -140 0 0 {name=p23 lab=bb[0:3]}
