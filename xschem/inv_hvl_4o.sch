...
C {devices/ipin.sym} 80 -230 0 0 {name=p39 lab=IN[0:3]}
C {devices/opin.sym} 60 -210 0 0 {name=p41 lab=OUT[0:3]}
C {devices/ipin.sym} 80 -190 0 0 {name=p42 lab=VDDH}
C {devices/ipin.sym} 80 -170 0 0 {name=p43 lab=GND}
C {devices/lab_pin.sym} 430 -350 0 1 {name=p3 sig_type=std_logic lab=OUT[0]}
C {devices/lab_pin.sym} 430 -290 0 1 {name=p5 sig_type=std_logic lab=OUT[1]}
C {devices/lab_pin.sym} 430 -230 0 1 {name=p6 sig_type=std_logic lab=OUT[2]}
C {devices/lab_pin.sym} 430 -170 0 1 {name=p7 sig_type=std_logic lab=OUT[3]}
C {devices/lab_pin.sym} 350 -350 0 0 {name=p10 sig_type=std_logic lab=IN[0]}
