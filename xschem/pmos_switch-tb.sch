...
N 330 -350 330 -200 {lab=A}
N 330 -350 560 -350 {lab=A}
N 560 -350 560 -280 {lab=A}
N 430 -140 430 -120 {
lab=GND}
C {devices/gnd.sym} 560 -120 0 0 {name=l1 lab=GND}
C {devices/gnd.sym} 330 -120 0 0 {name=l2 lab=GND}
C {devices/vsource.sym} 430 -170 0 0 {name=vg value="0"}
...
C {devices/vsource.sym} 330 -170 0 0 {name=VS value="0"}
...
C {devices/lab_wire.sym} 560 -200 0 0 {name=p2 sig_type=std_logic lab=B}
C {devices/lab_wire.sym} 330 -350 0 0 {name=p4 sig_type=std_logic lab=A}
C {devices/code_shown.sym} -210 -330 0 0 {name=s1 only_toplevel=false value="
.include $THESIS_WS/spice/pmos_switch-tb.sp"}
C {devices/launcher.sym} 100 -420 0 0 {name=h5
descr="load dc" 
tclcommand="xschem raw_read $netlist_dir/pmos_switch-tb.raw dc"
}
C {devices/vsource.sym} 690 -170 0 0 {name=VB value="5.5"}
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 540 -250 0 0 {name=M1
L=0.5
W=10
nf=1
mult=1
