...
descr="load tran" 
tclcommand="xschem raw_read $netlist_dir/vselector_6b_2v_stage_2-tb.raw tran"
}
C {devices/launcher.sym} 430 -380 0 0 {name=h1
descr="load dc" 
tclcommand="xschem raw_read $netlist_dir/vselector_6b_2v_stage_2-tb.raw dc"
}
...
C {devices/lab_pin.sym} 240 -220 0 0 {name=p4 sig_type=std_logic lab=v[0:16]}
C {devices/lab_pin.sym} 240 -200 0 0 {name=p5 sig_type=std_logic lab=d2[0:3]}
 ...
 * Vd13 d1[3] gnd pulse(0 \{vhi\} \{d13_d\} 1n 1n \{d1_th\} \{d1_t\})
  ...
  ********************Simulation Commands*****************************
  .control
     ...
     save all
     tran 10n 100u
     write vselector_6b_2v_stage_2-tb.raw
     set appendwrite
*    quit 0
  .endc
"}
C {devices/lab_pin.sym} 540 -220 0 1 {name=p1 sig_type=std_logic lab=vout[0:4]}
C {vselector_6b_2v_stage_2.sym} 390 -200 0 0 {name=x2}
